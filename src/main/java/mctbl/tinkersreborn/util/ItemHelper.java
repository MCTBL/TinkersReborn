...
public class ItemHelper {
    ...
    public static Object getStaticItem(String name, String classPackage) {
        try {
            ...
            TinkersReborn.LOG.warn("Could not find " + name + "from " + classPackage);
            return null;
        }
    }
    ...
    public static void spawnItemAtPlayer(EntityPlayer player, ItemStack stack) {
        if (!player.worldObj.isRemote) {
            ...
            // note that the addItemStackToInventory is not called for fake players
            ...
            // if it got picked up, we're playing the sound
                ...
                if (player instanceof EntityPlayerMP) {
                    player.worldObj.playSoundAtEntity(
                        ...
                        "random.pop",
                        0.2F,
                        ((TinkersReborn.random.nextFloat() - TinkersReborn.random.nextFloat()) * 0.7F + 1.0F) * 2.0F);
