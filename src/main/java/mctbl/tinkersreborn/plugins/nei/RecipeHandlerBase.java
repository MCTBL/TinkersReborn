...
public abstract class RecipeHandlerBase extends TemplateRecipeHandler {
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        try {
            if (outputId.equals("liquid") && results.length == 1 && results[0] instanceof FluidStack stack) {
                this.loadCraftingRecipes(stack);
            } else {
                super.loadCraftingRecipes(outputId, results);
            }
        } catch (Exception ex) {
            TinkersReborn.LOG.error(ex.getMessage());
        }
    }
    ...
    public void loadUsageRecipes(String inputId, Object... ingredients) {
        try {
            if (inputId.equals("liquid") && ingredients.length == 1 && ingredients[0] instanceof FluidStack stack) {
                this.loadUsageRecipes(stack);
            } else {
    ...
    public static List<Object> getSingleList(Object o) {
    ...
    public static FluidStack getFluidStack(ItemStack stack) {
        ...
        if ((fluidStack == null) && (Block.getBlockFromItem(stack.getItem()) instanceof IFluidBlock fluidBlock)) {
    ...
    public static class FluidTankElement {
        ...
        public void draw() {
            ...
            IIcon fluidIcon;
            if (this.flowingTexture && this.fluid.getFluid()
                .getFlowingIcon() != null) {
                fluidIcon = this.fluid.getFluid()
                    .getFlowingIcon();
            } else if (this.fluid.getFluid()
                .getStillIcon() != null) {
                    fluidIcon = this.fluid.getFluid()
                        .getStillIcon();
                } else {
