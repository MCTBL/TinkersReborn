...
public class CastingChannelDataProvider implements IWailaDataProvider {
    ...
    public static final String CONFIG_KEY = "tinkersreborn.castingchannel";
    ...
    public List<String> getWailaBody(ItemStack itemStack, List<String> currenttip, IWailaDataAccessor accessor,
        ...
        if (accessor.getTileEntity() instanceof CastingChannelLogic te) {
            ...
            if (internalTank.fluid != null && internalTank.fluid.amount > 0) {
                ...
                currenttip.add(TinkersStr.wailaAmounttag.toString() + fs.amount + "/" + internalTank.capacity);
            } else {
                currenttip.add(SpecialChars.ITALIC + TinkersStr.wailaEmpty.toString());
            }

            currenttip.add(TinkersStr.wailaSubtanks.toString());
            String s1, s2, s3, s4;
            s1 = s2 = s3 = s4 = TinkersStr.wailaEmpty.toString();
