    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelID,
        ...
        if (modelID == searedModel) {
            ...
            if (metadata == 0) {
                ...
                if (world.getTileEntity(x, y, z) instanceof CastingTableLogic logic) {
                ...
                if (world.getTileEntity(x, y, z) instanceof FaucetLogic logic) {
                    ...
                    if ((uBlock == TinkersRebornSmeltery.searedBlock) && uMeta == 0) {
                        yMin = -0.125F;
                    } else if ((uBlock == TinkersRebornSmeltery.searedBlock) && uMeta == 2) {
                        yMin = -0.75F;
                    } else if (uBlock == TinkersRebornSmeltery.lavaTank) {
                        yMin = -1F;
                    } else if (uBlock == TinkersRebornSmeltery.castingChannel) {
                        yMin = -0.5F;
                    }
