...
public class EntityArrow extends EntityProjectileBase {
    ...
    public EntityArrow(World world, EntityPlayer player, float speed, float inaccuracy, float power, ItemStack stack,
    ...
    protected void onEntityHit(Entity entityHit) {
        ...
        if (!this.worldObj.isRemote && entityHit instanceof EntityLivingBase entityLivingBaseHit) {
