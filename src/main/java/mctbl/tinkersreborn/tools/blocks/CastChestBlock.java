...
public class CastChestBlock extends TinkersRebornInventoryBlock implements ITinkersToolStationBlock {

    public CastChestBlock() {
        super(Material.wood);
        this.setHardness(2f);
    ...
    public boolean removedByPlayer(World world, EntityPlayer player, int x, int y, int z, boolean willHarvest) {
        ...
        if (!world.isRemote && world.getGameRules()
            ...
            CastChestLogic logic = (CastChestLogic) world.getTileEntity(x, y, z);
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float clickX,
        ...
        if (world.getTileEntity(x, y, z) instanceof CastChestLogic logic && !player.isSneaking()) {
