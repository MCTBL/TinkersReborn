...
public class SpawnParticlePacket extends AbstractPacketThreadsafe {
    ...
    public SpawnParticlePacket(Particles particle, double x, double y, double z, double xSpeed, double ySpeed,
        double zSpeed, int... data) {
    ...
    public void handleClientSafe(MessageContext netHandler) {
        TinkersReborn.proxy.spawnParticle(particle, null, x, y, z, xSpeed, ySpeed, zSpeed, data);
    }
