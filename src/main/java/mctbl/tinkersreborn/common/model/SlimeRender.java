...
public class SlimeRender extends RenderLiving {
    ...
    static final ResourceLocation texture = new ResourceLocation("tinkersreborn", "textures/mob/slimeedible.png");
    ...
    public void doRender(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9) {
        ...
        if (par1EntityLiving instanceof KingBlueSlime king) {
            BossStatus.setBossStatus(king, true);
        }
    }
    ...
    protected void scaleSlime(SlimeBase par1EdibleSlime, float par2) {
        float f1 = par1EdibleSlime.getSlimeSize() * 1.0F;
