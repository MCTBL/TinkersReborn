...
public interface IRepairable {
     ...
     * @return The returned item or null if repairItems retairns a non-null entry that can't be used for repairing or if
     *         the tool already is fully repaired.
     */
    @Nonnull
    ItemStack repair(ItemStack repairable, List<ItemStack> repairItems);
}
