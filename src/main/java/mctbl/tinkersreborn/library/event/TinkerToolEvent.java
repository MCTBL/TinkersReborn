...
public class TinkerToolEvent extends TinkersRebornEvent {
    ...
    public static class ExtraBlockBreak extends TinkerToolEvent {
        ...
        public ExtraBlockBreak(ItemStack itemStack, EntityPlayer player, Block state) {
            super(itemStack);
            this.player = player;
            this.state = state;
        }

        public static ExtraBlockBreak fireEvent(ItemStack itemStack, EntityPlayer player, Block state, int width,
     ...
     * Set the Result to DENY to let the Scythe know you handled the stuff (= harvest was successful, but not handled by
     * the scythe)
     */
    @HasResult
    @Cancelable
    public static class OnScytheHarvest extends TinkerToolEvent {
        ...
        public final BlockPos pos;
        public final EntityPlayer player;
        public final Block blockState;
        public final World world;
        public final boolean harvestable;

        public OnScytheHarvest(ItemStack itemStack, EntityPlayer player, World world, BlockPos pos, Block blockState,
            boolean harvestable) {
            super(itemStack);
            this.pos = pos;
            this.player = player;
        ...
        public static OnScytheHarvest fireEvent(ItemStack itemStack, EntityPlayer player, World world, BlockPos pos,
            Block blockState, boolean harvestable) {
