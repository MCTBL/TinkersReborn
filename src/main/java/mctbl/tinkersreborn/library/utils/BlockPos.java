...
public class BlockPos extends Vector3i implements Comparable<BlockPos> {
    ...
    /**
     * Returns an iterable of all BlockPos objects within the specified box. The
     * range is inclusive.
     *
    ...
    /**
     * Returns an iterable of BlockPos objects representing all positions within the
     * specified box. The range is inclusive.
     *
     ...
     * @return An iterable of BlockPos objects representing all positions within the
     *         specified box.
     */
