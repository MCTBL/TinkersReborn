package mctbl.tinkersreborn.library.world;

public class CoordTuple implements Comparable<CoordTuple> {
    ...
    public boolean equalCoords(int posX, int posY, int posZ) {
        if (this.x == posX && this.y == posY && this.z == posZ) return true;
        else return false;
    }
    ...
    @Override
    public int compareTo(CoordTuple o) {
